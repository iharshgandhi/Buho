#!/bin/bash
# =============================================================================
#  5a_merge_single.command
#
#  Merges Images/<chapter>/*.png with AudioSingle/<chapter>.mp3 into
#  Videos/<chapter>_single.mp4 — using the SINGLE-VOICE audio track.
#
#  REQUIRES Apple Silicon + h264_videotoolbox (hardware GPU encode).
#  No CPU fallback.
#
#  Run this after 4a_convert_single.command.
#
#  Behavior:
...
python "$SCRIPT_DIR/scripts/merge_to_video.py" --mode single
RC=$?
